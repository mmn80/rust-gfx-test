...
pub struct DynMeshWriteJob<'write> {
...
impl<'write> DynMeshWriteJob<'write> {
    pub fn new(
...
impl<'write> RenderFeatureWriteJob<'write> for DynMeshWriteJob<'write> {
    fn view_frame_index(&self, view: &RenderView) -> u32 {
    ...
    fn render_submit_node(
        ...
        let dyn_mesh = &render_object_instance.dyn_mesh;
        let mesh_part = dyn_mesh.inner.mesh_parts[mesh_part_index].as_ref().unwrap();
        ...
        command_buffer.cmd_bind_vertex_buffers(
            ...
            &[
                ...
                RafxVertexBufferBinding {
                    ...
                    byte_offset: (std::mem::size_of::<DynMeshModelMatrix>()
